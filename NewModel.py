...
dataset = os.path.join("C:\\Users\\SILICIUM\\PycharmProjects\\ML\\DL-CV-Masks\\dataset")
...
# load the VGG19 network, ensuring the head Fully Connected  layer sets are
# left off
